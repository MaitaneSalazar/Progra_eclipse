...
public class VistaForm extends JFrame {
	...
	public VistaForm() {
		...
		mensajes = new String [8];
		llenarArrays(textos, checks, mensajes);
	}

	private void llenarArrays(JTextField[] textos, JCheckBox[] checks, String[] mensajes)
	{
		textos[0] = text0;
		textos[1] = text1;
		textos[2] = text2;
